          ...
          <Container className="mx-auto px-4 py-5 max-w-[580px]">
            ...
            <Section className="mt-4">
              ...
              <Text className="text-base text-zinc-700 mt-3">
                Thank you for requesting a trial of {AppConfig.appName}. Your{" "}
                {trialDuration} Days trial license key is ready — use it to
                activate the app after downloading from the Microsoft Store.
              </Text>
            </Section>
            ...
            <Section className="mt-6">
              ...
              <Text className="text-sm text-zinc-600 mt-2 mb-0">
                1. Download {AppConfig.appName} from the Microsoft Store using
                the button below.
              </Text>
              ...
              <Text className="text-sm text-zinc-600 mt-1 mb-0">
                3. If you've opted for the "Done for You plan", reply to this
                email with your business data in excel/pdf/png format so we can
                start digitizing your data.
              </Text>
              <Text className="text-sm text-zinc-600 mt-1 mb-0">
