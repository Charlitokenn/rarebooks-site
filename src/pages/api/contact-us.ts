...
export const POST: APIRoute = async ({ request, locals }) => {
  try {
    ...
    if (!firstName || !lastName || !email || !mobile || !businessName || !message) {
      console.warn('Missing required fields:', { firstName: !!firstName, lastName: !!lastName, email: !!email, mobile: !!mobile, businessName: !!businessName, message: !!message });
