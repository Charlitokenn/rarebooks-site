---
sidebar_position: 7
sidebar_label: Customize Form
title: Customize Form
sidebar:
    order: 3
---

RareBooks allows you to customize all forms whether it's Invoice, or Party, or Item you can use the Customize Form feature to add additional fields to it.
...
You will have to reload RareBooks to see the option, you can press `Ctrl + R` if you are on Windows or linux, or `command + R` on macOS.
...
After enabling form customization and reloading RareBooks navigate to the Customize Form list view using the sidebar.
...
After customizing a form you must reload RareBooks to view the added fields in the forms. :::
