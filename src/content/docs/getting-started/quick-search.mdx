...
The Quick Search interface is a quick way to navigate around in RareBooks. To activate it you can click on the search button in the header:
...
:::tip[Fuzzy Search]
Because of the fuzzy search method used, you don't have to type the exact name of the thing you are searching.
...
:::tip[Info]
Docs* Rows of the *Docs\* type will show they type of entry it is. For example, Item or Purchase Invoice.
:::
...
:::tip[Skip Filters]
Skip Child Tables and Skip Transactions are used to toggle multiple Doc Filters at once.
:::
...
:::tip[Keyword Order]
The order of the keyword doesn't matter. You can enter the search keywords in any order.
:::
