...
Besides [Transactional Entries](https://github.com/frappe/books_docs/blob/master/transactions/transactional-entries) RareBooks has regular entries for documents that don't affect any account's balance directly.
